...
function Profile() {
  ...
  return loading ? (
    ...
    <div className="max-w-4xl flex items-center h-auto lg:my-10 flex-wrap mx-auto my-28 lg:my-0">
      <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
        <div className="p-4 md:p-12 text-center lg:text-left">
          ...
          <div className="mt-6">
            <Button value="Edit Profile" onClick={submitButton} primary />
          </div>
          ...
          <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
            ...
            <div>
              <svg className="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <title>YouTube</title>
